...
module.exports.updateUser = async (user) => {
    ...
    const query = {
        ...
        values: [sanitizedUsername, sanitizedPassword, sanitizedEmail, sanitizedAvatar, user.id],
    };
...
module.exports.createNote = async (note) => {
    ...
    return await pool.query(
        ...
        [sanitizeNames(note.name), sanitizedContent, sanitizeNames(note.category), note.createdat, note.updatedat, note.ownerid]
    );
};
...
module.exports.updateNote = async (note) => {
    ...
    const query = {
        ...
        values: [note.name, sanitizedContent, note.category, note.updatedat, note.id],
    };
